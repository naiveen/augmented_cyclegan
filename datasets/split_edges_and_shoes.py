...
parser.add_argument('--datasetSize', dest='datasetSize', help='Max number of examples to uset', type=str, default='65000')
...
num_imgs = min(len(img_list), int(args.datasetSize))
