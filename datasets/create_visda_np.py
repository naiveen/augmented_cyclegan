...
REAL_PATH = "/eai/datasets/public/visda2018/train"
SYNTH_PATH = "/eai/datasets/public/visda2018/validation"
SUBDIR_NAME = "visda2018"
...
parser.add_argument('--root', help='data directory', type=str, default='./{}'.format(SUBDIR_NAME))
